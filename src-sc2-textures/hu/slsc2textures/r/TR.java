 ...
 */
package hu.slsc2textures.r;

import java.io.InputStream;
import java.net.URL;

/**
 * Indicator class for the source of static resources of the sc2 textures.
 * 
...
public class TR {
	...
	public static URL get( final String name ) {
		return TR.class.getResource( name );
	}
	...
	public static InputStream getStream( final String name ) {
		return TR.class.getResourceAsStream( name );
	}
