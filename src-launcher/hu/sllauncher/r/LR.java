 ...
 */
package hu.sllauncher.r;

import java.io.InputStream;
import java.net.URL;

/**
 * Indicator class for the source of static resources of the launcher.
 * 
...
public class LR {
	...
	public static URL get( final String name ) {
		return LR.class.getResource( name );
	}
	...
	public static InputStream getStream( final String name ) {
		return LR.class.getResourceAsStream( name );
	}
